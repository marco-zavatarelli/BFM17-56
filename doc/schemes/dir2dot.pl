...
#
# Generates a directed graph of a directory tree using graphviz
# 
# Use it to generate the BFM tree with the commands
# cd ../$BFMDIR
# find bfm -type d -xdev -maxdepth 2 -print | ./dir2dot.pl > dirtree.dot
# dot -Tpng dirtree.dot > dirtree.png
#
