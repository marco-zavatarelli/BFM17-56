...
!
  ...
  D3STATETYPE(ppP1c)=ALLTRANSPORT
  D3STATETYPE(ppP2c)=ALLTRANSPORT
  D3STATETYPE(ppP3c)=ALLTRANSPORT
  D3STATETYPE(ppP4c)=ALLTRANSPORT
  D3STATETYPE(ppP1n)=ALLTRANSPORT
  D3STATETYPE(ppP2n)=ALLTRANSPORT
  D3STATETYPE(ppP3n)=ALLTRANSPORT
  D3STATETYPE(ppP4n)=ALLTRANSPORT
  D3STATETYPE(ppP1p)=ALLTRANSPORT
  D3STATETYPE(ppP2p)=ALLTRANSPORT
  D3STATETYPE(ppP3p)=ALLTRANSPORT
  D3STATETYPE(ppP4p)=ALLTRANSPORT
  D3STATETYPE(ppP1s)=ALLTRANSPORT
  D3STATETYPE(ppP1l)=ALLTRANSPORT
  D3STATETYPE(ppP2l)=ALLTRANSPORT
  D3STATETYPE(ppP3l)=ALLTRANSPORT
  D3STATETYPE(ppP4l)=ALLTRANSPORT
  D3STATETYPE(ppZ3c)=ALLTRANSPORT
  D3STATETYPE(ppZ4c)=ALLTRANSPORT
  if ( ppZ3n> 0 ) D3STATETYPE(ppZ3n)=ALLTRANSPORT
  if ( ppZ4n> 0 ) D3STATETYPE(ppZ4n)=ALLTRANSPORT
  if ( ppZ3p> 0 ) D3STATETYPE(ppZ3p)=ALLTRANSPORT
  if ( ppZ4p> 0 ) D3STATETYPE(ppZ4p)=ALLTRANSPORT
  D3STATETYPE(ppZ5c)=ALLTRANSPORT
  D3STATETYPE(ppZ6c)=ALLTRANSPORT
  if ( ppZ5n > 0 ) D3STATETYPE(ppZ5n)=ALLTRANSPORT
  if ( ppZ6n > 0 ) D3STATETYPE(ppZ6n)=ALLTRANSPORT
  if ( ppZ5p > 0 ) D3STATETYPE(ppZ5p)=ALLTRANSPORT
  if ( ppZ6p > 0 ) D3STATETYPE(ppZ6p)=ALLTRANSPORT
