...
subroutine create_outputfile
  ...
  integer :: time_start(1), time_count(1)
  ...
  do n = 1 , n_bfmvar
     ...
     call handle_err( nf90_inquire_variable(ncbfmid, IDvar, ndims=ndims, name=varname) )
     call handle_err( nf90_inq_varid(ncid, varname, IDtarget) )
     call handle_err( nf90_inquire_variable(ncid, IDtarget, ndims=ndims) )
